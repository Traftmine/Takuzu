...
int main(int argc, char *argv[]) {
  ...
  if (argc == 2) {
    ...
    printf("Error: Please either only pass <./game_text> as your argument or add a valid filename exp: $./game_text default.txt");
  }
  game_print(g);
  ...
  while (game_is_over(g) != true) {
    ...
    if (c == 'h') {
      printf(
          ...
          "cases de coordonées (i,j) ; vous avez le choix entre b (black), w (white) ou e (vide)\nLorsque vous écrivez vous devez indiquer w, b ou e puis les "
